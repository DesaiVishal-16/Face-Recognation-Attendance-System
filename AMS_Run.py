...
def manually_fill():
    ...
    sb.geometry('580x320')
    sb.configure(background='#120E43')
    ...
    def err_screen_for_subject():
        ...
        ec.title('Warning!!')
        ec.configure(background='#120E43')
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            MFW.configure(background='#120E43')
            ...
            def err_screen1():
                ...
                errsc2.configure(background='#120E43')
            ...
            def create_csv():
                ...
                csv_name='C:/Users/vishal/Desktop/A/Attendance/Manually Attendance/'+DB_table_name+'.csv'
                ...
                root.configure(background='#120E43')
            ...
            c1ear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="white", bg="grey", width=10,
                                     height=1,
                                     activebackground="Red", font=('times', 15, ' bold '))
            c1ear_enroll.place(x=690, y=100)

            c1ear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="white", bg="grey", width=10,
                                      height=1,
                                      activebackground="Red", font=('times', 15, ' bold '))
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\vishal\Desktop\A\Attendance\Manually Attendance\-------Check atttendance-------"')

            attf = tk.Button(MFW,  text="Check Sheets",command=attf,fg="white"  ,bg="skyblue1"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
    ...
    fill_manual_attendance = tk.Button(sb, text="Fill Attendance",command=fill_attendance, fg="white", bg="lime green", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    sc1.title('Warning!!')
    sc1.configure(background='#120E43')
...
def err_screen1():
    ...
    sc2.title('Warning!!')
    sc2.configure(background='#120E43')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='#120E43')
                cs = 'C:/Users/vishal/Desktop/A/' + fileName
    ...
    windo.configure(background='#120E43')
    Notifica = tk.Label(windo, text="Attendance filled Successfully", bg="Green", fg="white", width=33,
                            height=2, font=('times', 15, 'bold'))

    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\vishal\Desktop\A\Attendance\-------Check atttendance-------"')

    attf = tk.Button(windo,  text="Check Sheets",command=Attf,fg="white"  ,bg="skyblue1"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="white",command=Fillattendances, bg="lime green", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    win.configure(background='#120E43')
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'admin':
                ...
                cs = 'C:/Users/vishal/Desktop/A/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    c0 = tk.Button(win, text="Clear", command=c00, fg="white", bg="grey", width=10, height=1,
                            activebackground="Red", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)

    c1 = tk.Button(win, text="Clear", command=c11, fg="white", bg="grey", width=10, height=1,
                   activebackground="Red", font=('times', 15, ' bold '))
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-System", bg="#A855F7", fg="white", width=37,
...
lbl = tk.Label(window, text="Enter Roll NO:", width=20, height=2, fg="white", bg="blue", font=('times', 15, ' bold '))
...
lbl2 = tk.Label(window, text="Enter Your Name:", width=20, fg="white", bg="blue", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="white", fg="black", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="white"  ,bg="gray"  ,width=10  ,height=1 ,activebackground = "gray" ,font=('times', 15, ' bold '))
clearButton.place(x=965,y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="white"  ,bg="gray"  ,width=10 ,height=1, activebackground = "gray" ,font=('times', 15, ' bold '))
clearButton1.place(x=965, y=310)

AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="white"  ,bg="skyBlue1"  ,width=19 ,height=1, activebackground = "skyblue" ,font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="white"  ,bg="SkyBlue1", highlightbackground="blue"  ,width=20  ,height=3, activebackground = "skyblue" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="white",command=trainimg ,bg="SkyBlue1"  ,width=20  ,height=3, activebackground = "skyblue" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendace",fg="white",command=subjectchoose  ,bg="SkyBlue1"  ,width=20  ,height=3, activebackground = "skyblue" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="white"  ,bg="SkyBlue1"  ,width=20  ,height=3, activebackground = "skyblue" ,font=('times', 15, ' bold '))
